...
INSERT INTO category(categoryName) VALUES ('Head');
INSERT INTO category(categoryName) VALUES ('Upper Body');

INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Heart', 2, 'fresh out of the box',18.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Brain',1,'oozing with oil',19.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Eye',1,'clear as crystal',10.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Colon',2,'as smooth as it gets',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Lungs',2,'with lots of extra space',21.35);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Kidneys',2,'buy one get one free',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pancreas',2,'Do you want to eat this?',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Stomach',2,'with leftovers',40.00);
...
INSERT INTO admin (adminId) VALUES (@adminId);
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 4, 1, 31);
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 3, 30);
...
UPDATE Product SET productImageURL = 'img/heart.png' WHERE ProductId = 1;
UPDATE Product SET productImageURL = 'img/brain.jpg' WHERE ProductId = 2;
UPDATE Product SET productImageURL = 'img/eye.jpeg' WHERE ProductId = 3;
UPDATE Product SET productImageURL = 'img/colon.png' WHERE ProductId = 4;
UPDATE Product SET productImageURL = 'img/lung.png' WHERE ProductId = 5;
UPDATE Product SET productImageURL = 'img/kidneys.jpeg' WHERE ProductId = 6;
